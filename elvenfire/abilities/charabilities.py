...
class _CharacterAbility (_Ability):
    ...
    def __eq__(self, other):
        """Return boolean indicating if abilities are identical."""
    ...
    def duplicate(self, other):
        """Return boolean indicating if ability names (and elements) are identical."""
    ...
    def worsethan(self, other):
        """Return boolean indicating if other has a higher IIQ (or value)."""
        if self.IIQ == other.IIQ:
            return self.baseAC < other.baseAC
...
class MentalAbility (_CharacterAbility):
    ...
    elements['Storm'] = elements['Proof']
    elements['Calm'] = elements['Storm']
...
class MentalAbilityWithOpposites (MentalAbility):
    ...
    def __init__(self, name=None, IIQ=None, element=None, opposite=None):
        ...
        if self.opposite:
            if name is None:
                name = random.choice(pairs.keys())
            elif name not in self.pairs:
